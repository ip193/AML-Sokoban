...
def fit_agent_regression(load_agent_ind, step_distance=1, data_subset=100):
...
#     s = np.arange(0, data_length, data_subset)  # select a subset of the data so fitting doesn't take so long
#     print("Fitting plots...")
#     for ind, regr in enumerate(agent_regressors[load_agent_ind]):
#         regr.fit(X, y)
#         ...
...
(numagents, numplots) = (len(load_agents), len(agent_regressors[0]))
